...
Item {
    ...
    Component {
        ...
        Cp.Delegate {
            ...
            image: globals.showBanners && model.banner != "" ? (globals.cacheThumbnails ? model.bannerThumb : model.banner) : (model.poster != "" ? (globals.cacheThumbnails ? model.posterThumb : model.poster) : "qrc:/defaultImages/tvshow")
